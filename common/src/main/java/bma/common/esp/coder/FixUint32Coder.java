...
public class FixUint32Coder implements BaseCoder{
	/**
	 * @throws IOException 
	 * 
	...
	* @throws
	 */
	public static int fixUint32Decoder(InputStream buf) throws IOException{
		int s = 0;
		s += (buf.read() & 0xff) << 24;
		s += (buf.read() & 0xff) << 16;
		s += (buf.read() & 0xff) << 8;
