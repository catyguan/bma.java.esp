...
public class FixInt64Coder implements BaseCoder{
	/**
	 * @throws IOException 
	 * 
	...
	* @throws
	 */
	public static long fixInt64Decoder(InputStream buf) throws IOException{
		long s = 0;
